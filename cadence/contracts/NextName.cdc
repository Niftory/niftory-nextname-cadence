...
pub contract NextName: NonFungibleToken {
    ...
    pub struct SetData {
        ...
        init(setID: UInt32) {
            var referencedSet = &NextName.sets[setID] as &Set
    ...
    pub resource Collection: NextNameCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic { 
